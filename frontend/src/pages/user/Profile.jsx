...
const COUNTRIES = [
  ...
  'Germany', 'France', 'Japan', 'Mexico', 'Brazil', 'Spain', 'Italy',
  'China', 'South Korea', 'Netherlands', 'Other',
];
...
export default function Profile() {
  ...
  const handleUploadPicture = async () => {
    ...
    try {
      ...
      updateUser({ ...user, profile_picture: data.photo_url });
      setPictureFile(null);
  ...
  const pictureUrl = user?.profile_picture || user?.picture_url || user?.avatar;
    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="about_me" className="block text-sm font-medium text-gray-700 mb-1">About me</label>
            <textarea id="about_me" name="about_me" value={form.about_me} onChange={handleChange} rows={4}
          ...
          <div>
            ...
            <input id="languages" name="languages" type="text" value={form.languages} onChange={handleChange}
